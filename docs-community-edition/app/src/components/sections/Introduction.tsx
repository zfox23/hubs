    ...
    return (
        <div className='py-4 px-2 md:px-4 w-full max-w-4xl space-y-4'>
            ...
            <ul className='list-disc ml-4 !mt-2'>
                <li>Learn more about what Hubs Community Edition is</li>
                <li>Understand how to deploy Community Edition to Google Cloud Platform</li>
                <li>Learn how to deploy Community Edition to your own Unix-based server stack</li>
                <li>Explore the technology underlying Hubs Community Edition</li>
            </ul>
